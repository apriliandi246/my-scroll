...
const HTML_TEXT_SLIDES = `
   <main class="mys-multiscroll-slide-container" id="mys-multiscroll-slide-container">
      <!-- Slide 0 -->
      <div aria-hidden="false" data-mys-multiscroll-slide-type="full" class="mys-multiscroll-slide" style="z-index: 1">
         <div class="mys-multiscroll-slide__full" style="transform: translateY(0%)">
            <div class="mys-multiscroll-slide__content slide-0-full">Slide 0 Full</div>
         </div>
      </div>
      <!-- Slide 0 -->
      ...
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(100%)">
      ...
      <!-- Slide 2 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="full" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__full" style="transform: translateY(200%)">
            <div class="mys-multiscroll-slide__content slide-2-full">Slide 2 Full</div>
         </div>
      </div>
      <!-- Slide 2 -->
      ...
      <!-- Slide 3 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(300%)">
      ...
      <!-- Slide 4 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(400%)">
      ...
      <!-- Slide 5 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(500%)">
      ...
      <!-- Slide 6 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(600%)">
      ...
      <!-- Slide 7 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="full" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__full" style="transform: translateY(700%)">
            <div class="mys-multiscroll-slide__content slide-7-full">Slide 7 Full</div>
         </div>
      </div>
      <!-- Slide 7 -->
      ...
      <!-- Slide 8 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(800%)">
      ...
      <!-- Slide 9 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(900%)">
      ...
      <!-- Slide 10 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(1000%)">
      ...
      <!-- Slide 10 -->
      <div aria-hidden="true" data-mys-multiscroll-slide-type="multi" class="mys-multiscroll-slide">
         <div class="mys-multiscroll-slide__multi" style="transform: translateY(1100%)">
